...
**Carga por lotes.** El botón *Agregar varias fotos* deja elegir todas las
prendas de golpe. La app las procesa en fila, con barra de progreso, y después
aparece una rejilla para clasificarlas. Se pueden marcar varias fotos tocándolas
y asignarles la categoría de una sola vez — la gente fotografía por tandas
(primero los pantalones, después las blusas), así que eso resuelve la mayoría en
dos o tres toques. El nombre, la formalidad y el abrigo se ponen solos; todo se
puede corregir después con *Editar*.

Si eliges una sola foto, se abre el formulario de siempre.

**Nada se guarda sin categoría.** El formulario venía con "Prendas de arriba"
preseleccionado, así que quien no tocara ese campo guardaba unas zapatillas
como si fueran una blusa, sin ningún aviso. Ahora la categoría empieza vacía en
los dos caminos: en el formulario no deja guardar y explica qué falta, y en la
rejilla del lote las prendas sin clasificar salen marcadas en rojo, el botón de
guardar queda bloqueado y dice cuántas faltan. Tampoco se hereda la categoría de
la tanda anterior. Es más lento de escribir y bastante más difícil de arruinar.

**Por qué la categoría no se adivina sola.** Se midió sobre las 53 prendas ya
clasificadas de Allison si la silueta permitía distinguir un pantalón de una
blusa. No se puede: los rangos de alto/ancho se pisan casi por completo (las
prendas de arriba van de 1.12 a 1.91, que cubre a todas las demás categorías).
Sin un modelo entrenado, adivinar acertaría a medias, y corregir un error ajeno
cuesta más que elegir de cero. Por eso el esfuerzo se puso en clasificar rápido
en bloque, no en adivinar mal.
